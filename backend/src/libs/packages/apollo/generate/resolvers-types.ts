...
import { ApolloContext } from '../libs/types/types.js';
...
export type AuthDirectiveResolver<Result, Parent, ContextType = ApolloContext, Args = AuthDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type ValidationDirectiveArgs = {
  schemaName?: Maybe<Validation>;
};

export type ValidationDirectiveResolver<Result, Parent, ContextType = ApolloContext, Args = ValidationDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
